...
https://www.facebook.com/www.xnxx.c

🔵WHATSAPP NUMBER: wa.me/+8801615

🟢SUPPORT EMAIL: www.mdmnnm2004@gom`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/dDSh0ও.peg',
          'https://i.imgur.com/UucSRWJjpeg',
          'https://i.imgur.com/OYzHKNE.peg',
          'https://i.imgur.com/V5L9dPi.jpeg',
          'https://i.imgur.com/M7HEAM.jpeg'
        ]
